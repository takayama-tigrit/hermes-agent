...
# Last SessionDB()/kanban init error, per-process.  Surfaced in /resume and
    ...
    *,
    ...
    try:
        ...
        logger.warning(
            ...
            "falling back to journal_mode=DELETE. This usually means the "
            "database is on NFS / SMB / FUSE; see "
            "https://www.sqlite.org/wal.html for details. Concurrency will "
            "be reduced but the feature will work.",
            db_label,
            exc,
        )
